...
function body()
{
    ...
    if ($job_id) {
        ...
        $separate_dates = !empty($_POST['separate-dates']);
                ...
                <form method="post">
                    ...
                    <div class="form-row">
                        ...
                        <label class="form-check ml-3">
                            <input type="checkbox" name="separate-dates" value="1"
                                    <?php echo $separate_dates ? 'checked' : ''; ?>
                                   class="form-check-input">
            ...
            <div class="container">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <?php if ($separate_dates): ?>
                                <th>روز هفته</th>
                                <th>روز ماه</th>
                                <th>ماه</th>
                                <th>سال</th>
                            <?php elseif (!$dont_show_day_column): ?>
                                <th>تاریخ</th>
                            <?php endif; ?>
                            <th>زمان شروع</th>
                            <th>زمان پایان</th>
                        ...
                        <?php while ($r = $query->fetchObject()) : ?>
                            <tr>
                                <?php if ($separate_dates): ?>
                                    <td><?php echo jdate("l", $r->start) ?></td>
                                    <td><?php echo jdate("d", $r->start) ?></td>
                                    <td><?php echo jdate("F", $r->start) ?></td>
                                    <td><?php echo jdate("Y", $r->start) ?></td>
                                <?php elseif (!$dont_show_day_column) : ?>
                                    <td>
